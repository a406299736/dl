<?php /* Smarty version 2.6.28, created on 2015-01-26 17:07:17
         compiled from D:/WWW/data/form/1.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'explode', 'D:/WWW/data/form/1.php', 12, false),)), $this); ?>
<?php echo '<?php'; ?>
...
<td width='88%'><input type='text' class='inputText inputWidth' name='laiyuan' id='laiyuan' value='<?php if ($this->_tpl_vars['update']): ?><?php echo $this->_tpl_vars['laiyuan']; ?>
<?php else: ?><?php endif; ?>' /></td>
</tr>
<tr>
<td align='right' width='12%'>作者：</td>
<td width='88%'><input type='text' class='inputText inputWidth' name='zuozhe' id='zuozhe' value='<?php if ($this->_tpl_vars['update']): ?><?php echo $this->_tpl_vars['zuozhe']; ?>
<?php else: ?><?php endif; ?>' /></td>
</tr>
<tr>
