<?php /* Smarty version 2.6.28, created on 2015-01-29 13:20:06
         compiled from D:/WWW/data/form/15.php */ ?>
<?php echo '<?php'; ?>
...
<td width='88%'><input type='text' id='chanpinimt' name='chanpinimt' class='inputText inputWidth' value='<?php if ($this->_tpl_vars['update']): ?><?php echo $this->_tpl_vars['chanpinimt']; ?>
