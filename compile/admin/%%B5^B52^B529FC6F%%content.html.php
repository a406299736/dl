<?php /* Smarty version 2.6.28, created on 2016-11-15 22:27:51
...
?>
            <tr>
            	<td><input type="checkbox" class="checkVal" value="<?php echo $this->_tpl_vars['v']['id']; ?>
" name="id[]" /></td>
...
" target="_blank"><?php echo $this->_tpl_vars['v']['title']; ?>
                ...
                <td><a href='?m=Schtml&a=getUrlContent&classid=<?php echo $this->_tpl_vars['v']['classid']; ?>
&id=<?php echo $this->_tpl_vars['v']['id']; ?>
'>生成</a><a href="?m=Content&a=update&id=<?php echo $this->_tpl_vars['v']['id']; ?>
...
><?php echo $this->_tpl_vars['v']; ?>
                ...
                <input type="button" value="推送至专题" name="pushZt" id="pushZt" onclick="list_pushzt(<?php echo $this->_tpl_vars['classData']['classid']; ?>
);" class="inputSub1" />
                </td>
            </tr>
            </form>
