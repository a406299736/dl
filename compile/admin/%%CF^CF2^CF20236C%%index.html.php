<?php /* Smarty version 2.6.28, created on 2016-11-15 22:18:50
...
" checked /></td>
            ...
            <tr>
            	<td colspan="2" style="padding-left:4%; text-align:left;"><input type="checkbox" checked class="allcheckbox" />全选&nbsp;&nbsp;每卷长度：<input type="text" name="backsize" value="2048" class="inputText" style="width:30px; text-align:center;" />KB&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="备份数据" name="backdbUp" class="inputSub1" /> 每卷不要过大，否则会内存溢出</td>
            </tr>
        </form>
        </table>
    </div>
