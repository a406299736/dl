<?php /* Smarty version 2.6.28, created on 2014-11-26 19:38:30
         compiled from D:/phpStudy/WWW/data/form/3.php */ ?>
<?php echo '<?php'; ?>
...
<td width='88%'><input type='text' id='anlipic' name='anlipic' class='inputText inputWidth' value='<?php if ($this->_tpl_vars['update']): ?><?php echo $this->_tpl_vars['anlipic']; ?>
