<?php /* Smarty version 2.6.28, created on 2015-05-17 06:05:40
...
template/admin/js/jquery.js"></script>
<script type="text/javascript" src="<?php echo $this->_tpl_vars['weburl']; ?>
template/admin/js/main.js"></script>
...
<body class='errorBody'>
    <div class="error">
    	<h1>错误提示</h1>
        <h2><?php echo $this->_tpl_vars['str']; ?>
</h2>
        <p><a href="<?php echo $this->_tpl_vars['url']; ?>
">如果浏览器没有自动返回，请点击这里</a></p>
    </div>
</body>
</html>