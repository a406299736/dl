...
<td width='88%'><input type='text' id='tupianlb' name='tupianlb' class='inputText inputWidth' value='<{if $update}><{$tupianlb}><{else}><{/if}>' /> <input type='button' value='上传' class='inputSub1' onclick="selectUpload(1,'file/d/<{$classData.classpath}>','tupianlb',0)" /></td>
</tr>
<tr>
