...
<td width='88%'><input type='text' id='pimgs' name='pimgs' class='inputText inputWidth' value='<{if $update}><{$pimgs}><{else}><{/if}>' /> <input type='button' value='上传' class='inputSub1' onclick="selectUpload(1,'file/d/<{$classData.classpath}>','pimgs',0)" /></td>
</tr>
<tr>
