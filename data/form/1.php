...
<td width='88%'><input type='text' class='inputText inputWidth' name='laiyuan' id='laiyuan' value='<{if $update}><{$laiyuan}><{else}><{/if}>' /></td>
</tr>
<tr>
<td align='right' width='12%'>作者：</td>
<td width='88%'><input type='text' class='inputText inputWidth' name='zuozhe' id='zuozhe' value='<{if $update}><{$zuozhe}><{else}><{/if}>' /></td>
</tr>
<tr>
