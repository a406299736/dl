...
<td width='88%'><input type='text' id='chanpinimt' name='chanpinimt' class='inputText inputWidth' value='<{if $update}><{$chanpinimt}><{else}><{/if}>' /> <input type='button' value='上传' class='inputSub1' onclick="selectUpload(1,'file/d/<{$classData.classpath}>','chanpinimt',0)" /></td>
</tr>
<tr>
